  ...
  render() {
    ...
    <div className="row">
      ...
      <div className="col-lg-8 card">
         ...
         Ik zit in het derde jaar van mijn opleiding en ben op dit moment bezig met een minor software engineering, op dit moment beheers ik de programmeertalen: Python, C#, Java, Javascript, Typescript, SQL, Java, Kotlin, HTML, CSS, PHP en R😉. 
    ...
    return (
      <div className="row">
         <div className="col-lg-6 skills">
            ...
            <h3>Bedrijven</h3>
              <li className="list-group-item"><a href="https://teqplay.nl">TeqPlay B.V.</a></li>
