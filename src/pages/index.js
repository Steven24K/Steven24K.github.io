      ...
      <div className="container">
        ...
        <div className="crop">
          ...
          <div className="card">
           ...
           <a target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-green" href={this.props.data.site.siteMetadata.curriculum}>Download mijn Curriculum</a>
           ...
           <br />
            <a target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-orange" href="http://knapschiedam.nl">Kijk hier voor kaarten en meer informatie</a>
