    ...
    function App(props) {
        ...
        _this.changeTitle = function () {
            ...
            setInterval(function () {
                if (_this.state.title == Props.title2) {
                    _this.setState(__assign({}, _this.state, { title: Props.title1 }));
                }
                else {
                    _this.setState(__assign({}, _this.state, { title: Props.title2 }));
                }
                document.getElementsByTagName("title")[0].text = _this.state.title;
            }, 800);
        };
...
var Navigation = /** @class */ (function (_super) {
    ...
    function Navigation(props) {
        ...
        _this.toggleMenu = function () {
            console.log("clicked");
            if (this.state.menuIn == "Show Menu") {
                this.setState(__assign({}, this.state, { menuIn: "Hide" }));
            }
            else {
                this.setState(__assign({}, this.state, { menuIn: "Show Menu" }));
            }
        };
        _this.state = { menuIn: "Show Menu" };
    ...
    Navigation.prototype.render = function () {
        ...
        return (React.createElement("header", null,
            React.createElement("nav", { className: "navbar navbar-expand-sm bg-primary" },
                ...
                React.createElement("div", { className: "collapse navbar-collapse", id: "collapsibleNavbar" },
...
var About_1 = __webpack_require__(/*! ./About */ "./src/components/About.tsx");
var Contact_1 = __webpack_require__(/*! ./Contact */ "./src/components/Contact.tsx");
// 'HelloProps' describes the shape of props.
// State is never set so we use the '{}' type.
